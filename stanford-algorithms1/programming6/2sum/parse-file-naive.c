...
static void parse_file (char * addr, int length, int * data, int max_size, int * num_integers)
{
    char * line = addr;
...
int load_integers(const char * filename, int * data, int max_size, int * num_integers)
{
    int fd;
    struct stat sb;
    size_t length;
